        ...
        <main className="max-w-md mx-auto pb-10 w-full px-4">
          <div className="px-4 pt-4">
            <div className="flex bg-white dark:bg-[#242428] p-1 rounded-xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)]">
              <Link
                className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary text-white py-2.5 transition-all"
                href="/milestones"
              >
              ...
              <Link
                className="flex flex-1 items-center justify-center gap-2 rounded-lg text-gray-500 dark:text-gray-400 py-2.5"
                href="/milestones"
              >
