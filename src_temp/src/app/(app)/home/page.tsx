...
export default function HomePage() {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark transition-colors duration-300 min-h-screen flex flex-col antialiased">
      <StatusBar />
      <header className="px-5 pt-2 pb-6 flex items-center justify-between sticky top-12 z-40 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center shadow-lg shadow-purple-900/20 overflow-hidden p-1">
            <img
              alt="La Púrpura Wolf Logo"
              className="w-full h-full object-contain filter brightness-200"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDPStY8PgKRwJ9ah-B53h4-3V7oDUwTd8iwhUAHWshd-_6v7u18Ig_OVoAFuxvhmB2cVfvMrF4olW-LZByR3FSWfYZVPagNhk4-NRl1PKZ1cAQTcnFuxsHnLudGXos4Na-ld7X31hXao9IS8gUDbDolUud23wLMtt4FE7caFC1FXvy7nTsIQsmESKTsi5Iu0J4MhYFP0CNVvmGy-uT3_jS0oDd7HGmLx4CWo40v6J_OGRfY0i2RykpksOvsD0TBT4Zf7bJOl9kxaSE"
            />
          </div>
          <div>
            <h1 className="text-xl font-bold tracking-tight text-primary dark:text-white leading-none">
              La Púrpura
            </h1>
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-card-dark rounded-full shadow-sm border border-gray-100 dark:border-gray-700">
      ...
      <main className="flex-1 px-5 pb-24 space-y-6 overflow-y-auto hide-scrollbar">
        <section>
          <h2 className="text-2xl font-bold mb-4">Hola, {session?.user.name ?? "Ricardo"}</h2>
