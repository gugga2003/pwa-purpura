        ...
        <main className="flex-1 px-5 pt-4 pb-10">
          <div className="mb-8">
            ...
            <h1 className="text-[#171216] dark:text-white tracking-tight text-3xl font-extrabold leading-tight mb-2">
              ¡Bienvenido a <span className="text-primary">La Púrpura</span>!
            </h1>
            <p className="text-[#4b3d49] dark:text-gray-400 text-base font-medium leading-relaxed">
              Estás activando tu perfil como <span className="text-[#171216] dark:text-white font-bold">Referente</span> para el
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-2">
              ...
              <div className="mt-2 flex flex-wrap gap-x-4 gap-y-2 px-1">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-400">1 número</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="material-symbols-outlined text-[16px] text-gray-300">circle</span>
                  <span className="text-xs text-gray-600 dark:text-gray-400">1 símbolo</span>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="text-center pt-4">
              <p className="text-gray-500 dark:text-gray-500 text-xs">
                Si tienes problemas con la activación, contacta a tu coordinador territorial.
              </p>
            </div>
          </div>
        </main>
